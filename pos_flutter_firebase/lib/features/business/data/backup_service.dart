...
class BackupService implements BackupRepository {
  ...
  List<Sale> _salesFromMap(String businessId, List<dynamic> list) => _maps(list)
      .map((m) => Sale(
            ...
            discountName: m['discountName'] as String? ?? '',
            discountId: m['discountId'] as String? ?? '',
            discountType: m['discountType'] as String? ?? '',
            discountValue: ((m['discountValue'] as num?) ?? 0).toDouble(),
